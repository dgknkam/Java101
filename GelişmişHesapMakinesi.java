...
public class main {
    ...
    static void dikdortgenalanvcevre() {
        Scanner sc = new Scanner(System.in);
        ...
        System.out.println("Dİkdörtgenn Alanı = " + result);

        result = (2 * kisakenar) + (2 * uzunkenar);
    ...
    public static void main(String[] args) {
        ...
        do {
            ...
            System.out.print("Lütfen bir işlem seç :");
            select = scan.nextInt();
            switch (select) {
                case 1:
                    plus();
